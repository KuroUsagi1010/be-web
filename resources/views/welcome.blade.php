                ...
                <div class="card text-center mx-auto align" style="max-width: 500px !important">
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-row justify-content-center px-3">
                            <a class="mx-2" href="https://www.facebook.com/biblencourage"
                                style="text-decoration: none !important; color: #6f0021; font-size:24px"><i
                                    class="fab fa-facebook fa-lg"></i></a>
                            <a class="mx-2" href=" https://twitter.com/biblencourage"
                                style="text-decoration: none !important; color: #6f0021; font-size:24px"><i
                                    class="fab fa-twitter fa-lg"></i></a>
                            <a class="mx-2" href="https://www.instagram.com/biblencourage"
                                style="text-decoration: none !important; color: #6f0021; font-size:24px"><i
